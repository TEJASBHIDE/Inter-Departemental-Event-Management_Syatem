...
// Fetch upcoming and completed events for student's department
$stmt = $pdo->prepare("SELECT * FROM events WHERE department_id = (SELECT department_id FROM students WHERE student_id = ?) ORDER BY event_date ASC");
    ...
    <main class="flex-1 md:ml-64 p-6">
      <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <?php if ($msg): ?>
            <div id="alert" class="alert-message mb-6 px-4 py-3 rounded-lg bg-indigo-50 text-indigo-800 flex items-center">
                  ...
                  <div class="card-body">
                    ...
                    <div class="flex justify-between items-center text-xs text-gray-500">
                      <div>
                        ...
                        <span><?= $event['max_participants'] ?? 'No Limit' ?> max</span>
                      </div>
                      <div>
          ...
          <?php else: ?>
            <div class="text-center py-12">
              ...
              <p class="text-gray-500">There are currently no events scheduled for your department.</p>
            </div>
          <?php endif; ?>
        </div>
      </div>
